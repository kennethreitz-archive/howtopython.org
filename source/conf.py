...
# -*- coding: utf-8 -*-
#
# howtopython documentation build configuration file, created by
...
htmlhelp_basename = 'howtopythondoc'
...
latex_documents = [
    (master_doc, 'howtopython.tex', 'howtopython Documentation',
...
man_pages = [
    (master_doc, 'howtopython', 'howtopython Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'howtopython', 'howtopython Documentation',
     author, 'howtopython', 'One line description of project.',
     'Miscellaneous'),
]
